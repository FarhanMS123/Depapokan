...
<body class="p-0 pt-5 pb-4 m-0" style="background: #EEEEEE;">
    <div class="row justify-content-center">
        <div class="col-12 col-md-4">
            <div class="card">
                <form action="{{ route("ubah", $id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="conImg" class="mb-1">
                                <img id="img" class="w-100" src="{{ asset($padepokan->gambar) }}">
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error("nama") is-invalid @enderror" id="inputNama" name="nama" value="{{ old("nama") ?? $padepokan->nama }}">
                            @error("nama")
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="deskripsi" class="form-control @error("deskripsi") is-invalid @enderror" id="areaDeskripsi" rows="3">{{ old("deskripsi") ?? $padepokan->deskripsi }}</textarea>
                            @error("deskripsi")
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
